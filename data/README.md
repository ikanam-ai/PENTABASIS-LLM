# Контракт данных PENTA-10

Данные PENTA-10 разделены на первичные, экспертные и производные объекты. Первичные ответы никогда не перезаписываются после получения.
...
PENTA-10 не собирает массовые ответы людей. Идентификаторы экспертов псевдонимизируются; таблица соответствия хранится отдельно от исследовательских записей и не входит в публичный выпуск.
