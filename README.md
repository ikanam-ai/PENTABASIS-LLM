<div align="center">
  <img src="assets/pentabasis-llm-concept.svg" alt="PENTABASIS-LLM — карта Пентабазиса для оценки языковых моделей" width="100%">
</div>

<div align="center">

[![Язык](https://img.shields.io/badge/язык-русский-1f6feb)](#pentabasis-llm)
...
4. **AdAEM** задаёт автоматическое расширение диагностических вопросов; в PENTABASIS-LLM его цель дополнена абсолютным соответствием нормативному конструкту.
...
До выхода эмпирического выпуска используйте метаданные из [`CITATION.cff`](CITATION.cff) и указывайте версию конструкта `pentabasis-10-0.1`.
