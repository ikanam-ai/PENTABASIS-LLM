...
Эксперты калибруют измеритель. PENTA-AI v0.1 не собирает распределение ценностей населения и не использует ответы людей как нормативный эталон.
