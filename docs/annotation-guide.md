# Руководство по разметке PENTABASIS-LLM

Руководство задаёт единый способ перехода от свободного ответа языковой модели к проверяемым меткам PENTABASIS-LLM.
